...
After installation, the CIS Benchmarks are available within the GUI.

\begin{itemize}
 \item CIS Scan Screenshot
\end{itemize}

The scan results will also be available in the GUI.

\begin{itemize}
 \item AKS 1.0 Result Screenshot
\end{itemize}
