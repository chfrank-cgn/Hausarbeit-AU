...
\begin{abstract}
In this paper, we will examine the new NIS2 security standards, compare them to the current set of CIS controls, and evaluate the use of CSI benchmarks to check the readiness of Kubernetes clusters for NIS2 and mitigate risks of cyber attacks.
